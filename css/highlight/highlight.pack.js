...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
aliases:["pl","pm"],keywords:s,contains:c}}})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
}],illegal:/\S/}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
...
skip:!0})]}]})})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(t).concat(_)}}})());hljs.registerLanguage("http",(()=>{"use strict";return e=>{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}})());hljs.registerLanguage("less",(()=>{"use strict";return e=>{
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
end:/$/}]})})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
}return t=>{const n=(t=>{const n=t.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+e(r)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",s={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},i={className:"string",
...
;return n.name="C",n.aliases=["c","h"],n}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
